...
if __name__ == '__main__':
    ...
    # load grid
    grid = Grid(grid_name, grid_dir=grid_dir, read_lines=True, read_spectra=False, read_elines=True)
        ...
        for log10Z in  grid.bin_centres['log10Z']:
            ...
            for aox in grid.bin_centres['aox']:
                ...
                for log10n_H in grid.bin_centres['log10n_H']:
                    ...
                    # intrinsic 
                    elines = grid.get_elines_info(line_ids, grid_point_indices)
                    x__, y__ = elines.get_diagram(diagram_id)
