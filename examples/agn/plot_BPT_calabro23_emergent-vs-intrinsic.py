        ...
        for log10Z in  grid.bin_centres['log10Z']:
            ...
            for aox in grid.bin_centres['aox']:
                ...
                for log10n_H in grid.bin_centres['log10n_H']:
                    ...
                    # intrinsic 
                    intrinsic_lines = grid.get_lines_info(line_ids, grid_point_indices, intrinsic = True)
                    x__, y__ = intrinsic_lines.get_diagram(diagram_id)
                    
                    ax.scatter(np.log10(x__), np.log10(y__), c='k', marker = '*')
